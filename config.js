...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './queendiana.db' : process.env.DATABASE_URL;
...
module.exports = {
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '```👸🏻 Queen Diana Beta Version```' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '```👸🏻 Queen Diana Beta Version```' : process.env.CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://telegra.ph/file/3217c19d381ae34b38012.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    INBOX_BLOCK: process.env.INBOX_BLOCK === undefined ? 'false' : process.env.INBOX_BLOCK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/3217c19d381ae34b38012.jpg' : process.env.ALIVE_LOGO,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'QUEEN DIANA' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'DIABOt' : process.env.BOT_NAME,
    ...
    CAPTION_MSG: process.env.CAPTION_MSG === undefined ? 'copyright (c) 2021 Queen Diana' : process.env.CAPTION_MSG,
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY === undefined ? 'fcc481ff-0cd1-41c4-9df9-c3cd2c736154' : process.env.HEROKU_API_KEY,
        APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'Queen Dianamd1' : process.env.HEROKU_APP_NAME
    },
    DATABASE_URL: DATABASE_URL,
    DATABASE: DATABASE_URL === './queendiana.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
    ...
    SUPPORT: "94769370897-1415817281",
    SUPPORT2: "94769370897-1458298055",
    SUPPORT3: "94769370897-1446476993",
    Support4: "94769370897-1630672792",
    AMDI_1: "94769370897-1533638214",
    AMDI_2: "94769370897-1415817281",
    AMDI_3: "94769370897-1631633729",
    AMDI_4: "94769370897-1631905677",
    AMDI_5: "94769370897-1636094186",
    AMDI_6: "972542559113-1376904403",
    AMDI_7: "94769370897-1636286090",
    OWN: "94769370897,0"
};
